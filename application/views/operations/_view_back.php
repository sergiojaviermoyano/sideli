        ...
        <div class="col-lg-10  section_cheques">
            ...
            <div class="row ">
                <div class="col-lg-3">
                    ...
                    <input type="text" class="form-control" id="operationChequeNro" name="cheche_in[nro][]" autocomplete="off"/>
                    
                </div>
                <div class="col-lg-3">
                    <label class="">Banco: </label>
                    <input type="text" class="form-control typeahead" id="operationBanco"  data-provide="typeahead" name="cheche_in[banco_nombre][]" />
                    <input type="hidden" id="banco_id" name="cheche_in[banco_id][]" >   
                </div> 
                <div class="col-lg-3">
                    <label class="">Importe : </label>
                    <input type="numeric" class="form-control cheque_importe_in" id="operationImporte" name="cheche_in[importe][]" style="text-align: right"/>
                </div> 
                <div class="col-lg-1">
                    <label class=""></label>
...
var banco_1={
    ...
    $(function(){
        ...
        //$(document).on('keyup','.bancos_in',function(){
        ...
        $(".add_checks_in").click(function(){
            ...
            _new_cheque_fields+='<div class="row ">';
            _new_cheque_fields+='    <div class="col-lg-3">';
            _new_cheque_fields+='        <label class="">Nro : </label>';
            _new_cheque_fields+='        <input type="text" class="form-control" id="operationChequeNro" name="cheche_in[nro][]" autocomplete="off"/>';                    
            _new_cheque_fields+='    </div>';
            _new_cheque_fields+='    <div class="col-lg-3">';
            _new_cheque_fields+='        <label class="">Banco: </label>';
            _new_cheque_fields+='        <input type="text" class="bancos_ins form-control typeahead " id=""  data-provide="typeahead" name="cheche_in[banco_nombre][]" />';
            _new_cheque_fields+='        <input class="" type="hidden"  name="cheche_in[banco_id][]" > ';
            _new_cheque_fields+='    </div> ';
            _new_cheque_fields+='    <div class="col-lg-3">';
            _new_cheque_fields+='        <label class="">Importe : </label>';
            _new_cheque_fields+='        <input type="numeric" class="form-control cheque_importe_in " id="operationImporte" name="cheche_in[importe][]" style="text-align: right"/> ';                   
            _new_cheque_fields+='    </div> ';

            _new_cheque_fields+='    <div class="col-lg-1">';
            _new_cheque_fields+='        <label class=""></label>';
            _new_cheque_fields+='        <button class="btn btn-link btn-xs btn-block delete_checks_in"><span class="glyphicon glyphicon-remove" aria-hidden="true"></span></button> ';           
            _new_cheque_fields+='    </div> ';
            _new_cheque_fields+='</div>';
        ...
        //$(document).on('click','.bancos_in',function(){
            
        $(document).on('click','.bancos_ins',function(){
            console.debug("tEsdas");
            var id=$(this).data('id');
                $(this).typeahead({
                minLength: 3,
                items: 'all',
